...
// FIXXME should actually extend Tree_Common, to use the methods provided
// in there... but we need to connect to the db here, so we extend optionsDB
// for now, may be use "aggregate" function to fix that
{
    ...
    function _move( $idToMove , $newParentId , $newPrevId=0 )
    {
        ...
        if ($newPrevId) {
            ...
            if (PEAR::isError($newParent=$this->getElement($newParentId))) {
                return $newParent;
            }
        }
