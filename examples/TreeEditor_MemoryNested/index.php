<?php
    ...
    if( strpos($HTTP_HOST,'ashley') !== false ) // sorry but my template class is there :-)
        ini_set('include_path',ini_get('include_path').':/usr/local/httpd/includes');
    ...
    require_once('SimpleTemplate/Filter/Modifier.php');
